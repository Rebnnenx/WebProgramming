...
<?php
	...
	function outputOrderRow($file,$title, $quantity, $price){
		$rowAmount=number_format($quantity*$price, 2, ".", ",");
		echo "<tr>
                 ...
                 <caption>Customer: <strong>Mount Royal University</strong></caption>
                  ...
                  <tfoot>
                      <tr class="totals">
						  ...
						  <td>
                        <?php
							echo number_format($quantity1*$price1+$quantity2*$price2+$quantity3*$price3+$quantity4*$price4, 2,".",",");
						?>
						</td>
                      </tr>
                      <tr class="totals">
